...
so a slow pipeline drops frames instead of falling behind in wall-clock time.
"""
...
class Camera:
    ...
    def open(self) -> None:
        ...
        # FOURCC has to be set before the resolution: V4L2 negotiates the mode
        # from the pixel format, so asking for a size first pins us to YUYV.
        if self._fourcc:
    ...
    def describe(self) -> str:
        """What the driver actually granted, which is often not what we asked."""
